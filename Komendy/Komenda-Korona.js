...
module.exports = {
    name: "korona",
    description: "Podaje informacje o ilości zakażeń, zgonów i wyzdrowień na koronawirusa.",
    guildOnly: true,
    aliases: ["k"],
        ...
        if (arg === "wszystkie") {
            const data = await axios.get("https://disease.sh/v3/covid-19/all").then(({ data }) => data)
        ...
        const data = await axios.get("https://disease.sh/v3/covid-19/countries").then(({ data }) => data)
