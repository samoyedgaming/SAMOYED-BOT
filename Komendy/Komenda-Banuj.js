...
module.exports = {
    ...
    run(msg, args) {
        ...
        if (!memberToBan.bannable) {
            ...
            .setTitle(botname)
            .setColor(0xb65307)
            .setDescription("Masz za niską role do używania tej komendy albo użytkownik którego chcesz zbanować ma za wysoką role.")
            .addField("Autor", botauthor, true)
            .addField("Wersja", botversion, true)
        ...
        memberToBan.ban(banOptions).then((bannedUser) => {
            ...
            .setTitle(botname)
            .setColor(0xb65307)
            .setDescription(`Użytkownik \`${bannedUser.displayName}\` został zbanowany. \n${reasonArg ? `\nPowód: ${reasonArg}` : ""}`)
            .addField("Autor", botauthor, true)
            .addField("Wersja", botversion, true)
