...
exports.GiveawayMessages = {
    ...
    inviteToParticipate: 'Zareauguj 🎉 żeby wziąć udział!',
    winMessage: 'Gratulacje, {winners}! Wygraliście **{this.prize}**!\n{this.messageURL}',
    drawing: 'Koniec: {timestamp}',
    dropMessage: 'Bądz pierwszy który zareaguje 🎉 !',
    embedFooter: 'Ilość wygranych: {this.winnerCount}',
    noWinner: 'Giveway anulowany',
    winners: 'Wygrani:',
    endedAt: 'Zakończony',
    hostedBy: 'Utworzony przez: {this.hostedBy}'
};
...
exports.LastChanceOptions = {
    enabled: false,
    content: '⚠️ **Ostatnia szansa na wzięcie udziału !** ⚠️',
    threshold: 5000,
    embedColor: '#FF0000'
};
...
exports.GiveawayRerollOptions = {
    winnerCount: null,
    messages: {
        congrat: ':tada: Nowi wygrani: {winners}!Gratulacje, wygraliście **{this.prize}**!\n{this.messageURL}',
